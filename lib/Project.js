...
/**
 * @param {boolean} skipImports Option to not parse or add protos from imports
 * @return {Project}
 */
Project.prototype.setSkipImports = function (skipImports) {
  this._followImports = !skipImports
  return this
}
